...
## End-point: DELETE CATE (NOT TEST )
### Method: DELETE
>```
>{{host}}/admin/category/64bb4e1582a5abc6b1c13305
>```
...
## End-point: GET COURES HAVE BOUGHT
### Method: GET
>```
>{{host}}/admin/orders
>```
...
## End-point: GET SECTIONS BY COURSE ID
### Method: GET
>```
...
## End-point: GET LESSONS BY SECTION ID
### Method: GET
>```
...
## End-point: GET COURSES AFTER LOGIN
### Method: GET
>```
...
## End-point: GET CART RETRIEVE FROM DB
### Method: GET
>```
...
## End-point: GET COURSE BY ID ENROLLED BY USER ID
### Method: GET
>```
...
## End-point: GET SECTIONS BY COURSE ID AT ENROLLED COURSE
### Method: GET
>```
>{{host}}/sections/646891c65ff2f5b8930b5329/course
>```
...
## End-point: GET LESSONS BY SECTION ID AT ENROLLED COURSE
### Method: GET
>```
...
## End-point: POST COURSE REVIEW BY USER ID
### Method: POST
>```
...
## End-point: GET USER BY ID DETAIL
### Method: GET
>```
...
## End-point: GET COURES HAVE BOUGHT BY USER ID
### Method: GET
>```
...
## End-point: POST ORDER - CREATE ORDER
### Method: POST
>```
>{{host}}/order
>```
...
## End-point: POST ORDER - CREATE ORDER Copy
### Method: POST
>```
>{{host}}/order
>```
...
## End-point: UPDATE LESSON DONE BY USER ID
### Method: POST
>```
...
## End-point: DELETE CERTIFICATION
### Method: DELETE
>```
...
## End-point: GET CERTIFICATES BY COUSRE ID AND USER ID
### Method: GET
>```
...
## End-point: GENERATE RANDOM COURSES
### Method: GET
>```
...
## End-point: GENERATE RANDOMS COURSES
### Method: GET
>```
>{{host}}/genrate-random-courses
>```
...
## End-point: CALL API FROM UNSPLASH
### Method: GET
>```
...
## End-point: GENERATE OUTLINE FROM COURSE NAME
### Method: GET
>```
...
## End-point: CREATE OUTLINE COURSE
### Method: POST
>```
...
## End-point: GENERATE LESSONS OF OUTLINE
### Method: GET
>```
...
## End-point: CREATE LESSON BASE ON OUTLINE COURSE
### Method: POST
>```
...
## End-point: GENERATE WHOLE COURSE BY COURSE ID
### Method: GET
>```
...
## End-point: CREATE WHOLE COURSE BY COURSE ID
### Method: POST
>```
...
## End-point: GET YOUTUBE VIDEOS FROM YOUTUBE API
### Method: GET
>```
...
## End-point: PUT USER - UPDATE USER
### Method: PUT
>```
...
|role|ADMIN|text|
|email|info@trannhatsang.com|text|
...
## End-point: DELETE USER (NOT TEST )
### Method: DELETE
>```
>{{host}}/admin/users/6468a173401d3810494f479a
>```
...
## End-point: UPDATE LAST LOGIN FOR USER
### Method: PATCH
>```
...
```json
{
    "lastLogin": "Thu Aug 10 2023 09:08:08 GMT+0700 (Giờ Đông Dương)"
}
```


⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃ ⁃
# 📁 Collection: Reports Center 


## End-point: Report Summary
### Method: GET
>```
...
## End-point: Report Course Sales (30 days, 60 days, ... )
### Method: GET
>```
...
## End-point: Report revenues (30 days .... )
### Method: GET
>```
...
## End-point: Report for users progress
### Method: GET
>```
...
## End-point: Report for course insights
### Method: GET
>```
